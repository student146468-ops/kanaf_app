...
- الحساب الجديد يستقبل رمز تحقق على الإيميل فقط، وليس SMS.
- بعد تأكيد الحساب، يكون الدخول بالبريد الإلكتروني وكلمة المرور.
- يلزم إعداد Brevo على الخادم؛ راجع [دليل التحقق بالبريد](docs/EMAIL_VERIFICATION.md).
