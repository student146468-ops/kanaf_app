...
urlpatterns = [
    path('admin/', RedirectView.as_view(pattern_name='dashboard', permanent=False), name='admin_dashboard'),
    ...
    path('volunteer-opportunities/', views.volunteer_opportunities_view, name='volunteer_opportunities_list'),
